...
export const feePercentages: Record<string, number> = {
  ...
  "Electrical and Mechanical Drawings": 5.0,
...
export const componentHierarchy: Record<string, number> = {
  ...
  "Electrical and Mechanical Drawings": 4,
...
export const componentDescriptions: Record<string, string> = {
  ...
  "Initial Sketch Design": "We prepare basic conceptual sketches to translate your vision into an initial plans.",
  "Final Plan after Revisions": "Incorporates all required client revisions and finalizes the architectural plan, sections and elevations.",
  ...
  "Electrical and Mechanical Drawings": "Detailed electrical circuit and switch layout for safe and convenient power distribution.",
