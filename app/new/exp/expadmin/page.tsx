...
export default function ExpenseMonitorPage() {
  ...
  const filteredProjects = useMemo(
    () =>
      filterOrg
        ? projects.filter((p) => p.organisation_id === Number(filterOrg))
        : projects,
    [projects, filterOrg],
  );
      ...
      >
        ...
        >
                ...
                {loading ? (
                  ...
                  sortedRows.map((row) => (
                    ...
                    >
                      ...
                      >
                        <span
                          style={{ fontSize: 13, fontWeight: 600, color: T.t1 }}
                        >
                          {fmtINR(row.amount)}
                        </span>
                      </td>
          ...
          {data && data.count > 0 && (
            ...
            >
              <span
                style={{ fontSize: 11.5, color: T.t5, whiteSpace: "nowrap" }}
              >
                Showing{" "}
