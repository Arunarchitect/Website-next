...
export const organisations: Organisation[] = [
  ...
  // Worklog / salary / performance orgs
...
export const projects: Project[] = [
  ...
  // Worklog / salary / performance projects
...
// Seeded salary + misc expenses
// `expenses` is consumed by the finance component.
// Hand-written real expense data is `expenseRecords` above.
